...
export const HIGHLIGHT_RIGHT_BLOCK = "highlight_right_block";
export const HIGHLIGHT_BOTTOM_BLOCK = "highlight_bottom_block";
export const HIGHLIGHT_LEFT_BLOCK = "highlight_left_block";
...
export const ADD_TO_INPUT_PATTERN_ARRAY = "add_to_input_pattern_array";
export const CLEAR_INPUT_PATTERN_ARRAY = "clear_input_pattern_array";
export const INCREMENT_INPUT_COUNTER = "increment_input_counter";
